...
and it is the unique minimizer, up to measure-preserving relabeling, of
...
\input{sections/singular_stationary_family}
\input{sections/singular_constant_comparison}
\input{sections/singular_localization}
\input{sections/singular_auxiliary_lagrangian}
\input{sections/singular_graphon_comparison}
\input{sections/singular_proof}
