...
cross-block edge density.  The six functions
\[
  q_{11}(p,r),\quad q_{12}(p,r),\quad q_{22}(p,r),\quad
  c(p,r),\quad e(W_{p,r}),\quad \Phi_H(p,r)
\]
are real-analytic on $U\cap\{(p,r):p<\pc(r)\}$.
