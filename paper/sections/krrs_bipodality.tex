...
\subsection{Status}
\label{kb:sec:status}
Every step above is formalized in Lean, in \texttt{UpperTailOptimizers/Bipodality/}; the
theorem is \texttt{KRRSFamily.isOptimal} (\texttt{Bipodality/Optimal.lean}), and
\texttt{krrs\_rectangle} (\texttt{KRRS/Main.lean}) is derived from it.  The only project axioms
