...
/-!
# Elementary power-function inequalities (Section 5 toolkit)

Quantitative facts about `x ↦ x^k` on `[0,1]` used throughout Section 5
("Universal non-degeneracy") of `paper/bipodal_optimizer.tex`:
