...
For the two-block bipodal graphon `V_{r,c,q}` of §5.2 of `paper/bipodal_optimizer.tex`
...
the small block (`bipodalGraphon_tDensity_sum` of `Graphon/BipodalBridge.lean`
