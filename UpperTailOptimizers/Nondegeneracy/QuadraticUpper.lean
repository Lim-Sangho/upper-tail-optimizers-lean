...
/-!
# The matching quadratic upper bound (`lem:bipodal-quadratic-bound` of `paper/bipodal_optimizer.tex`)
...
See the module documentation of `Nondegeneracy/BipodalUpper.lean` for the proof
strategy (a quantitative one-variable intermediate-value solve replacing the paper's
analytic implicit function theorem and patching argument).
-/
