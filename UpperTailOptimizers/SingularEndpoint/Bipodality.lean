...
/-!
# Bipodality of rank-one KKT points: the scalar core (Section 7)

This file proves the scalar half of `lem:stationary-rank-one-bipodality` of `paper/singular_endpoint.tex`:
