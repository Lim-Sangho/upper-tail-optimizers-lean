...
This is a generic fact about the binomial relative entropy, with no Section-7 content of its
...
Its one consumer is the central-square bound in `SingularEndpoint/GraphonComparisonMain.lean`.
