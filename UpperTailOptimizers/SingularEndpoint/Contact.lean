...
/-!
# The singular endpoint contact identities (Section 7, `paper/singular_endpoint.tex`)
...
* `cast_sub_one`, `cast_sub_two` — `((d-1 : ℕ) : ℝ) = (d : ℝ) - 1` and its `d - 2` companion
  under `2 ≤ d`, shared with `SingularEndpoint/FamilyBase.lean`, `SingularEndpoint/FamilyDeriv.lean`,
  `SingularEndpoint/FkktDeriv.lean` and `SingularEndpoint/FirstVariationBound.lean`;
...
behind the fourth-order coefficient of `SingularEndpoint/Fkkt4.lean`. -/
