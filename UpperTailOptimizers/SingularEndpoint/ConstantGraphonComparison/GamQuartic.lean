...
used in `SingularEndpoint/LocalizationRankOne/Quartic.lean`: `Γ_d, Γ_d', Γ_d'', Γ_d'''` all vanish at `r_*`
...
quotient between `(K ∓ ε)/24`.  The ε/pinching idiom is the one of `SingularEndpoint/RankOneStationaryFamily/Order4.lean`.
