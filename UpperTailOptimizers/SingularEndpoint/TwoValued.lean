...
/-!
# Two-valuedness of rank-one KKT factors: the measure-theoretic step (Section 7)

This file carries the scalar core of `lem:stationary-rank-one-bipodality` of `paper/singular_endpoint.tex`
