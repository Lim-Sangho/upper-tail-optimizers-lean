...
/-!
# The base point of the family system (Section 7, `paper/singular_endpoint.tex`)

`SingularEndpoint/FamilySystem.lean` replaces the degenerate rank-one KKT system
...
`SingularEndpoint/Contact.lean`.  Indeed, at `h = 0` the values recorded by `Esys2_zero`,
