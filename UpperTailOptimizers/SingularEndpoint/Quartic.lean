...
/-!
# The quartic localization bounds (Section 7, `paper/singular_endpoint.tex`)
...
```
Γ_d(u) ≥ c_d |u - r_*|^4          (eq:endpoint-gap-quartic-bound)
R_d(u)^2 ≤ C_d Γ_d(u)             (the unnumbered `R_d² ≤ C_dΓ_d`)
```
