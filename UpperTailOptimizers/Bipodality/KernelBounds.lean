...
`SingularEndpoint/FactorHDensity.lean` use nothing about the rank-one decomposition except that
...
proof.  The proofs are those of `SingularEndpoint/FactorHDensity.lean`, verbatim up to the
namespace.
-/
